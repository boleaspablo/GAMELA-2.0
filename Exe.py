...
os.system("clear")
print(Style.BRIGHT + Fore.RED + "#" + Style.RESET_ALL + Style.BRIGHT + Fore.YELLOW + "##" + Style.RESET_ALL + Style.BRIGHT + Fore.RED + "#" + Style.RESET_ALL + " GAMELA v2.0 " + Style.RESET_ALL + Style.BRIGHT + Fore.RED + "#" + Style.RESET_ALL + Style.RESET_ALL + Style.BRIGHT + Fore.YELLOW + "##" + Style.RESET_ALL + Style.RESET_ALL + Style.BRIGHT + Fore.RED + "#\n" + Style.RESET_ALL)

try:
    # Se intenta acceder a Google con un timeout de 5 segundos
